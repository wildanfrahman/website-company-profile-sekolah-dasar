        ...
        <div class="col-md-4">
          <div class="card mb-3 shadow-sm">
            ...
            <div class="card-body">
              ...
              <p style="text-align: justify;" class="card-text mb-4"><?php echo substr($d['konten'], 0, 66) ?>...</p>
              <div class="d-flex justify-content-end">
                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                  <a href="detailpost.php?idartikel=<?= $d['idartikel'] ?>"><button type="button" class="btn btn-success me-2">Lebih Lanjut</button></a>
                </div>
              </div>
            </div>
          </div>
